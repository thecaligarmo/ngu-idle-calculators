    ...
    return (
        <Container title="Stats">
            ...
            <ContentSection title="Augments">
                <ul>
                    <li key="eNGU" className=""><strong>Total Augment Speed Factor:</strong> <span className="text-red-500">{pn(totalAugmentSpeed(player), fmt)}%</span></li>
                </ul>
            ...
            <ContentSection title="NGU">
                <ul>
                    <li key="eNGU" className=""><strong>Total Energy NGU Speed Factor:</strong> <span className="text-red-500">{pn(totalEnergyNGUSpeedFactor(player), fmt)}%</span></li>
                    <li key="mNGU" className=""><strong>Total Magic NGU Speed Factor:</strong> <span className="text-red-500">{pn(totalMagicNGUSpeedFactor(player), fmt)}%</span></li>
                </ul>
            ...
            <ContentSection title="Exp/AP/PP">
                <ul>
                    <li key="exp"><strong>Total Exp Bonus:</strong> <span className="text-red-500">{pn(totalExpBonus(player), fmt, 2)}%</span></li>
                    <li key="ap"><strong>Total AP Bonus:</strong> <span className="text-red-500">{pn(totalAPBonus(player), fmt, 2)}%</span></li>
                    <li key="pp"><strong>Total PP Bonus:</strong> <span className="text-red-500">{pn(totalPPBonus(player), fmt, 2)}%</span></li>
                </ul>
            ...
            <ContentSection title="Misc.">
                <ul>
                    <li key="daycare"><strong>Total Daycare (Kitty) Bonus:</strong> <span className="text-red-500">{pn(totalDaycareSpeed(player), fmt, 2)}%</span></li>
                    <li key="hack"><strong>Total Hack Bonus:</strong> <span className="text-red-500">{pn(totalHackSpeed(player), fmt, 2)}%</span></li>
                    <li key="wish"><strong>Total Wish Bonus:</strong> <span className="text-red-500">{pn(totalWishSpeed(player), fmt, 2)}%</span></li>
                </ul>
            ...
            <ContentSection title="Misc Stats">
                <ul>
                    <li key="goldDrop"><strong>Total Gold Drop:</strong> <span className="text-red-500">{pn(totalGoldDrop(player), fmt)}%</span></li>
                    <li key="respawn"><strong>Total Respawn:</strong> <span className="text-red-500">{pn(totalRespawnRate(player), fmt, 2)}%</span> ({pn(totalRespawnRate(player).divide(bd(25)), fmt, 2)} seconds)</li>
                    <li key="dropChance"><strong>Total Drop Chance:</strong> <span className="text-red-500">{pn(totalDropChance(player), fmt)}%</span></li>
                </ul>
            ...
            <ContentSection title="Beards Stats">
                <ul>
                    <li key="eBeards"><strong>Total Energy Beard Speed Factor:</strong> <span className="text-red-500">{pn(totalEnergyBeardSpeed(player), fmt)}%</span></li>
                    <li key="mBeards"><strong>Total Magic Beard Speed Factor:</strong> <span className="text-red-500">{pn(totalMagicBeardSpeed(player), fmt)}%</span></li>
                </ul>
            ...
            <ContentSection title="Wandoos Stats">
                <ul>
                    <li key="eWandoos"><strong>Total Wandoos Energy Speed:</strong> <span className="text-red-500">{pn(totalEnergyWandoosSpeed(player), fmt)}%</span></li>
                    <li key="mWandoos"><strong>Total Wandoos Magic Speed:</strong> <span className="text-red-500">{pn(totalMagicWandoosSpeed(player), fmt)}%</span></li>
                </ul>
            ...
            </ContentSection>
            {
                ...
                ? <ContentSection title="Quest Stats">
                    <ul>
                        <li key="questRewards"><strong>Total QP Reward:</strong> <span className="text-red-500">{pn(totalQuestRewardBonus(player), fmt)}%</span></li>
                        <li key="questDrop"><strong>Total Quest Item Drop:</strong> <span className="text-red-500">{pn(totalQuestDropBonus(player), fmt, 2)}%</span></li>
                    </ul>
            ...
            }
            {
                ...
                ? <ContentSection title="Card Stats">
                    <ul>
                        <li key="mayoSpeed"><strong>Total Mayo Speed:</strong> <span className="text-red-500">{pn(totalMayoSpeed(player), fmt, 2)}%</span></li>
                        <li key="cardSpeed"><strong>Total Card Speed:</strong> <span className="text-red-500">{pn(totalCardSpeed(player), fmt, 2)}%</span></li>
                        <li key="tagEffect"><strong>Total Tag Effect:</strong> <span className="text-red-500">{pn(totalTagEffect(player), fmt, 2)}%</span></li>
                    </ul>
