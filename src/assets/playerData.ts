...
export const playerDataInfo: { [k: string]: dataInfoType } = {
    ...
    hackAdventureTarget: { type: "number", default: 0, max: 7632 },
    hackAugmentTarget: { type: "number", default: 0, max: 7456 },
    hackBloodTarget: { type: "number", default: 0, max: 7252 },
    hackDaycareTarget: { type: "number", default: 0, max: 7048 },
    hackDropChanceTarget: { type: "number", default: 0, max: 7544 },
    hackENGUTarget: { type: "number", default: 0, max: 7340 },
    hackExpTarget: { type: "number", default: 0, max: 6960 },
    hackHackTarget: { type: "number", default: 0, max: 6757 },
    hackMilestoneReductionAdventure: { type: "number", default: 0, name: "Adventure Milestone Reduction", max: 5 },
    hackMilestoneReductionAugment: { type: "number", default: 0, name: "Augment Milestone Reduction", max: 2 },
    hackMilestoneReductionBlood: { type: "number", default: 0, name: "Blood Milestone Reduction", max: 5 },
    hackMilestoneReductionDaycare: { type: "number", default: 0, name: "Daycare Milestone Reduction", max: 5 },
    hackMilestoneReductionDropChance: { type: "number", default: 0, name: "Drop Chance Milestone Reduction", max: 4 },
    hackMilestoneReductionENGU: { type: "number", default: 0, name: "Energy NGU Milestone Reduction", max: 3 },
    hackMilestoneReductionExp: { type: "number", default: 0, name: "Experience Milestone Reduction", max: 5 },
    hackMilestoneReductionHack: { type: "number", default: 0, name: "Hack Milestone Reduction", max: 10 },
    hackMilestoneReductionMNGU: { type: "number", default: 0, name: "Magic NGU Milestone Reduction", max: 3 },
    hackMilestoneReductionNumber: { type: "number", default: 0, name: "Number Milestone Reduction", max: 5 },
    hackMilestoneReductionPP: { type: "number", default: 0, name: "PP Milestone Reduction", max: 3 },
    hackMilestoneReductionQP: { type: "number", default: 0, name: "QP Milestone Reduction", max: 5 },
    hackMilestoneReductionStat: { type: "number", default: 0, name: "Attack/Defense Milestone Reduction", max: 2 },
    hackMilestoneReductionTimeMachine: { type: "number", default: 0, name: "Time Machine Milestone Reduction", max: 5 },
    hackMilestoneReductionWish: { type: "number", default: 0, name: "Wish Milestone Reduction", max: 5 },
    hackMNGUTarget: { type: "number", default: 0, max: 7340 },
    hackNumberTarget: { type: "number", default: 0, max: 6873 },
    hackPPTarget: { type: "number", default: 0, max: 6757 },
    hackQPTarget: { type: "number", default: 0, max: 7164 },
    hackStatTarget: { type: "number", default: 0, max: 7720 },
    hackTimeMachineTarget: { type: "number", default: 0, max: 7544 },
    hackWishTarget: { type: "number", default: 0, max: 6262 },
    ...
    totalEnergyCap: { type: "number", default: 0, calculated: true, max: 9e18 },
    totalEnergyNGUSpeedFactor: { type: "number", default: 0, percent: true, calculated: true },
    totalEnergyPower: { type: "number", default: 0, calculated: true, max: 1e18 },
    ...
    totalMagicCap: { type: "number", default: 0, calculated: true, max: 9e18 },
    totalMagicNGUSpeedFactor: { type: "number", default: 0, percent: true, calculated: true },
    totalMagicPower: { type: "number", default: 0, calculated: true, max: 1e18 },
