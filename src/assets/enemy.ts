...
export const Enemies :  {[k: string]: Enemy} = {
    ...
    ORANGE_TOUPEE_WITH_FISTS: new Enemy(106, "oRANGETOUPEEWITHFISTSBOSS", "ORANGE TOUPEE WITH FISTS (BOSS)", ENEMY_TYPE.CHARGER, new AttackStat(1.2, bd(750000), bd(750000), bd(75000), bd(54000000)), true),
    A_CLOGGED_SHOWER_DRAIN: new Enemy(108, "aCLOGGEDSHOWERDRAINBOSS", "A CLOGGED SHOWER DRAIN (BOSS)", ENEMY_TYPE.POISON, new AttackStat(1.2, bd(750000), bd(750000), bd(75000), bd(55000000)), true),

    // Badly Drawn World
    BADLY_DRAWN_DRAGON: new Enemy(109, "badlyDrawnDragon", "Badly Drawn Dragon", ENEMY_TYPE.NORMAL, new AttackStat(1, bd(11000000), bd(11000000), bd(1100000), bd(1E+09))),
    REALLY_BAD_SONIC_FANART: new Enemy(110, "reallyBadSonicFanart", "Really Bad Sonic Fanart", ENEMY_TYPE.CHARGER, new AttackStat(1, bd(11200000), bd(11200000), bd(1102000), bd(1E+09))),
    BADLY_DRAWN_SCHOOLGIRL: new Enemy(111, "badlyDrawnSchoolgirl", "Badly Drawn Schoolgirl", ENEMY_TYPE.POISON, new AttackStat(1.1, bd(11400000), bd(11400000), bd(1140000), bd(1.01E+09))),
    NO_ENEMY: new Enemy(112, "noEnemy", "No Enemy(?)", ENEMY_TYPE.RAPID, new AttackStat(1.2, bd(11600000), bd(11600000), bd(1160000), bd(1.02E+09))),
    REALLY_BAD_MLP_FANART: new Enemy(113, "reallyBadMLPFanart", "Really Bad MLP Fanart", ENEMY_TYPE.GROWER, new AttackStat(1.1, bd(11800000), bd(11800000), bd(1180000), bd(1.03E+09))),
    LOSS_PNG: new Enemy(114, "losspng", "Loss.png", ENEMY_TYPE.PARALYZE, new AttackStat(1.2, bd(11000000), bd(11000000), bd(1100000), bd(1.04E+09))),
    EVIL_SPIKY_HAIRED_GUY: new Enemy(115, "eVILSPIKYHAIREDGUY", "EVIL SPIKY HAIRED GUY", ENEMY_TYPE.RAPID, new AttackStat(1.2, bd(11200000), bd(11200000), bd(1120000), bd(1.05E+09)), true),
    EVIL_BADLY_DRAWN_KITTY: new Enemy(116, "eVILBADLYDRAWNKITTY", "EVIL BADLY DRAWN KITTY", ENEMY_TYPE.PARALYZE, new AttackStat(1.2, bd(11500000), bd(11500000), bd(1150000), bd(1.06E+09)), true),

    // Boring-Ass Earth
    THE_EIFFEL_TOWER: new Enemy(117, "theEiffelTower", "The Eiffel Tower", ENEMY_TYPE.NORMAL, new AttackStat(1, bd(89000000), bd(89000000), bd(8900000), bd(8.5E+09))),
    A_MUMMY: new Enemy(118, "aMummy", "A Mummy", ENEMY_TYPE.CHARGER, new AttackStat(1, bd(89000000), bd(89000000), bd(8900000), bd(8.5E+09))),
    A_DADDY: new Enemy(119, "aDaddy", "A Daddy", ENEMY_TYPE.POISON, new AttackStat(1.1, bd(89200000), bd(89200000), bd(8920000), bd(8.52E+09))),
    TWO_BANANAS_IN_PYJAMAS: new Enemy(120, "twoBananasInPyjamas", "Two Bananas In Pyjamas", ENEMY_TYPE.RAPID, new AttackStat(1.2, bd(89400000), bd(89400000), bd(8940000), bd(8.54E+09))),
    GIANT_RAISINS_FROM_CALIFORNIA: new Enemy(121, "giantRaisinsFromCalifornia", "Giant Raisins From California", ENEMY_TYPE.GROWER, new AttackStat(1.1, bd(89600000), bd(89600000), bd(8960000), bd(8.56E+09))),
    AN_ANNOYING_PENGUIN: new Enemy(122, "anAnnoyingPenguin", "An Annoying Penguin", ENEMY_TYPE.PARALYZE, new AttackStat(1.2, bd(89800000), bd(89800000), bd(8980000), bd(8.58E+09))),
    AN_ARMY_OF_ANNOYING_PENGUINS: new Enemy(123, "anArmyofAnnoyingPenguins", "An Army of Annoying Penguins", ENEMY_TYPE.RAPID, new AttackStat(1.2, bd(90000000), bd(90000000), bd(9000000), bd(8.6E+09))),
    THE_ELUSIVE_CS: new Enemy(124, "tHEELUSIVECSBOSS", "THE ELUSIVE C.S (BOSS)", ENEMY_TYPE.POISON, new AttackStat(1.2, bd(90000000), bd(90000000), bd(9000000), bd(8.6E+09)), true),

    //Chocolate World
    CHOCOLATE_MOUSE: new Enemy(125, "chocolateMouse", "Chocolate Mouse", ENEMY_TYPE.NORMAL, new AttackStat(1, bd(3e10), bd(3e10), bd(3e09), bd(3e12))),
    CHOCOLATE_MIMIC: new Enemy(126, "chocolateMimic", "Chocolate Mimic", ENEMY_TYPE.RAPID, new AttackStat(1, bd(3.01e10), bd(3.01e10), bd(3.01e09), bd(3.05e12))),
    CHOCOLATE_CROWBAR: new Enemy(127, "chocolateCrowbar", "Chocolate Crowbar", ENEMY_TYPE.POISON, new AttackStat(1.1, bd(3.01e10), bd(3.01e10), bd(3.01e09), bd(3.05e12))),
    CHOCO_FREEMAN: new Enemy(128, "chocoFreeman", "Choco-Freeman", ENEMY_TYPE.RAPID, new AttackStat(1.2, bd(3.02e10), bd(3.02e10), bd(3.02e09), bd(3.1e12))),
    CHOCOLATE_FONDUE: new Enemy(129, "chocolateFondue", "Chocolate Fondue", ENEMY_TYPE.EXPLODER, new AttackStat(12, bd(3.02e10), bd(3.02e10), bd(3.02e09), bd(3.1e12))),
    CHOCOLATE_SLIME: new Enemy(130, "chocolateSlime", "Chocolate Slime", ENEMY_TYPE.POISON, new AttackStat(1.2, bd(3.03e10), bd(3.03e10), bd(3.03e09), bd(3.15e12))),
    DARK_CHOCOLATE: new Enemy(131, "darkChocolate", "Dark Chocolate", ENEMY_TYPE.RAPID, new AttackStat(1.2, bd(3.03e10), bd(3.03e10), bd(3.03e09), bd(3.15e12))),
    CHOCOLATE_SALTY_BALLS: new Enemy(132, "chocolateSaltyBalls", "Chocolate Salty Balls", ENEMY_TYPE.RAPID, new AttackStat(1.2, bd(3.03e10), bd(3.03e10), bd(3.03e09), bd(3.15e12))),
    SCREAMING_CHOCOLATE_FISH: new Enemy(133, "screamingChocolateFish", "Screaming Chocolate Fish", ENEMY_TYPE.RAPID, new AttackStat(1.2, bd(3.03e10), bd(3.03e10), bd(3.03e09), bd(3.15e12))),
    A_MIGHTY_LUMP_OF_POO: new Enemy(134, "aMightyLumpofPoo", "A Mighty Lump of Poo", ENEMY_TYPE.RAPID, new AttackStat(1.2, bd(3.03e10), bd(3.03e10), bd(3.03e09), bd(3.15e12))),
    MELTED_CHOCOLATE_BLOB: new Enemy(135, "mELTEDCHOCOLATEBLOBBOSS", "MELTED CHOCOLATE BLOB (BOSS)", ENEMY_TYPE.GROWER, new AttackStat(1.2, bd(3.05e10), bd(3.05e10), bd(3.05e09), bd(3.25e12)), true),
    CHOCO_GIANT: new Enemy(136, "cHOCOGIANTBOSS", "CHOCO GIANT (BOSS)", ENEMY_TYPE.RAPID, new AttackStat(1.2, bd(3.05e10), bd(3.05e10), bd(3.05e09), bd(3.25e12)), true),
    TYPE_TWO_DIABETES: new Enemy(137, "tYPEDIABETESBOSS", "TYPE 2 DIABETES (BOSS)", ENEMY_TYPE.CHARGER, new AttackStat(1.2, bd(3.05e10), bd(3.05e10), bd(3.05e09), bd(3.25e12)), true),
    ...
    EVIL_ICARUS_PROUDBOTTOM: new Enemy(320, "evilIcarusProudbottom", "Evil Icarus Proudbottom", ENEMY_TYPE.EXPLODER, new AttackStat(12, bd(5.02e12), bd(5.02e12), bd(5.02e11), bd(5.1e14))),
    ...
    EVIL_SPIKY_HAIRED_GUY_BOSS: new Enemy(323, "eVILSPIKYHAIREDGUYBOSS", "EVIL SPIKY HAIRED GUY (BOSS)", ENEMY_TYPE.RAPID, new AttackStat(1.2, bd(5.05e12), bd(5.05e12), bd(5.05e11), bd(5.25e14)), true),
    ...
    THE_MORE_YOU_KNOW_STAR: new Enemy(327, "TheMoreYouKnowStar", "'The More You Know' Star", ENEMY_TYPE.CHARGER, new AttackStat(1.1, bd(2.51e13), bd(2.51e13), bd(2.51e12), bd(2.55e15))),
    A_FABULOUS_LEPRECHAUN: new Enemy(328, "aFabulousLeprechaun", "A Fabulous Leprechaun", ENEMY_TYPE.GROWER, new AttackStat(1.2, bd(2.52e13), bd(2.52e13), bd(2.52e12), bd(2.6e15))),
    ...
    A_WEIRD_GOBLIN_DEMON_THING: new Enemy(155, "aWeirdGoblinDemonThing", "A Weird Goblin-Demon-Thing", ENEMY_TYPE.RAPID, new AttackStat(1.2, bd(1.08e16), bd(1.08e16), bd(1.08e15), bd(1.2e18))),
    ...
    THE_DRAGON_OF_WISDOM: new Enemy(157, "tHEDRAGONOFWISDOMBOSS", "THE DRAGON OF WISDOM (BOSS)", ENEMY_TYPE.GROWER, new AttackStat(1.2, bd(1.12e16), bd(1.12e16), bd(1.12e15), bd(1.25e18)), true),
    THE_DRAGON_OF_DILDO: new Enemy(158, "tHEDRAGONOFDILDOBOSS", "THE DRAGON OF DILDO (BOSS)", ENEMY_TYPE.GROWER, new AttackStat(1.2, bd(1.15e16), bd(1.15e16), bd(1.15e15), bd(1.25e18)), true),
    ...
    THE_ENTIRE_STATE_OF_SOUTH_DAKOTA: new Enemy(162, "theEntireStateofSouthDakota", "The Entire State of South Dakota", ENEMY_TYPE.NORMAL, new AttackStat(1.2, bd(1.06e17), bd(1.06e17), bd(1.06e16), bd(1.15e19))),
    ...
    THREE_GUYS_SHOUTING_OUT_ED: new Enemy(164, "threeGuysShoutingoutEd", "Three Guys Shouting out 'Ed'", ENEMY_TYPE.EXPLODER, new AttackStat(12, bd(1.1e17), bd(1.1e17), bd(1.1e16), bd(1.2e19))),
    ...
    THE_LIFE_OF_THE_PARTY: new Enemy(166, "tHELIFEOFTHEPARTYBOSS", "THE LIFE OF THE PARTY (BOSS)", ENEMY_TYPE.GROWER, new AttackStat(1.2, bd(1.15e17), bd(1.15e17), bd(1.15e16), bd(1.25e19)), true),
    ...
    ELDER_TYPO_GOD_ELXU: new Enemy(174, "eLDERTYPOGODELXUBOSS", "ELDER TYPO GOD, ELXU (BOSS)", ENEMY_TYPE.GROWER, new AttackStat(1.2, bd(8.15e19), bd(8.15e19), bd(8.15e18), bd(8.25e21)), true),
    ...
    GIANT_METAL_SPINNING_TOP: new Enemy(176, "giantMetalSpinningTop", "Giant Metal Spinning Top", ENEMY_TYPE.RAPID, new AttackStat(1, bd(4.02e20), bd(4.02e20), bd(4.02e19), bd(4.1e22))),
    A_STACK_OF_KRAZY_BONEZ: new Enemy(177, "aStackofKrazyBonez", "A Stack of Krazy Bonez", ENEMY_TYPE.CHARGER, new AttackStat(1.1, bd(4.04e20), bd(4.04e20), bd(4.04e19), bd(4.15e22))),
    RARE_FOIL_POKEYMAN_CARD: new Enemy(178, "rareFoilPokeymanCard", "Rare Foil Pokeyman Card", ENEMY_TYPE.NORMAL, new AttackStat(1.2, bd(4.06e20), bd(4.06e20), bd(4.06e19), bd(4.15e22))),
    ...
    DEMONIC_FLURBIE: new Enemy(182, "dEMONICFLURBIEBOSS", "DEMONIC FLURBIE (BOSS)", ENEMY_TYPE.GROWER, new AttackStat(1.2, bd(4.15e20), bd(4.15e20), bd(4.15e19), bd(4.25e22)), true),
    ...
    MIMIC_MIMIC_CHEST_CHEST: new Enemy(184, "mimicMimicChestChest", "Mimic 'Mimic Chest' Chest", ENEMY_TYPE.PARALYZE, new AttackStat(1, bd(2.02e21), bd(2.02e21), bd(2.02e20), bd(2.1e23))),
    ...
    PAIR_OF_SHADES_WEARING_SHADES: new Enemy(197, "pairofShadesWearingShades", "Pair of Shades Wearing Shades", ENEMY_TYPE.PARALYZE, new AttackStat(1, bd(2.02e24), bd(2.02e24), bd(2.02e23), bd(2.1e26))),
    ...
    A_GIANT_VAT_OF_PLUTONIUM: new Enemy(195, "aGiantVatofPlutonium", "A Giant Vat of Plutonium-238", ENEMY_TYPE.CHARGER, new AttackStat(1.1, bd(2.04e24), bd(2.04e24), bd(2.04e23), bd(2.15e26))),
    MUTANT_ZOMBIE_MARIE_CURIE: new Enemy(196, "mutantZombieMarieCurie", "Mutant Zombie Marie Curie", ENEMY_TYPE.NORMAL, new AttackStat(1.2, bd(2.06e24), bd(2.06e24), bd(2.06e23), bd(2.15e26))),
    ...
    A_MASSIVE_SEALED_VAULT: new Enemy(199, "aMassiveSealedVault", "A Massive Sealed Vault", ENEMY_TYPE.NORMAL, new AttackStat(1.2, bd(2.12e24), bd(2.12e24), bd(2.12e23), bd(2.25e26))),
    RADIOACTIVE_MACGUFFIN: new Enemy(200, "rADIOACTIVEMACGUFFINBOSS", "RADIOACTIVE MACGUFFIN (BOSS)", ENEMY_TYPE.GROWER, new AttackStat(1.2, bd(2.15e24), bd(2.15e24), bd(2.15e23), bd(2.25e26)), true),
    ...
    THE_FLYING_SPINELLI_MONSTER: new Enemy(350, "theFlyingSpinelliMonster", "The Flying Spinelli Monster", ENEMY_TYPE.CHARGER, new AttackStat(1.1, bd(3.04e26), bd(3.04e26), bd(3.04e25), bd(3.15e28))),
    ...
    A_PATHETIC_TUMBLEWEED: new Enemy(359, "aPatheticTumbleweed", "A Pathetic Tumbleweed", ENEMY_TYPE.POISON, new AttackStat(1.2, bd(1.56e27), bd(1.56e27), bd(1.56e26), bd(1.55e29))),
    ...
    HERD_OF_PISSED_OFF_COWS: new Enemy(361, "herdofPissedOffCows", "Herd of Pissed Off Cows", ENEMY_TYPE.GROWER, new AttackStat(1.1, bd(1.6e27), bd(1.6e27), bd(1.6e26), bd(1.6e29))),
    ...
    ANGRY_RAW_COOKIE_DOUGH: new Enemy(202, "angryRawCookieDough", "Angry Raw Cookie Dough", ENEMY_TYPE.PARALYZE, new AttackStat(1, bd(1.02e29), bd(1.22e29), bd(1.22e28), bd(5.4e30))),
    ...
    BUTCHER_CANDLESTICK_MAKER: new Enemy(204, "butcherCandlestickMaker", "Butcher & Candlestick Maker", ENEMY_TYPE.NORMAL, new AttackStat(1, bd(1e29), bd(1.2e29), bd(1.2e28), bd(5.7e30))),
    ...
    A_DAY_OLD_BAGUETTE: new Enemy(208, "aDAYOLDBAGUETTEBOSS", "A DAY-OLD BAGUETTE (BOSS)", ENEMY_TYPE.GROWER, new AttackStat(1.2, bd(1.1e29), bd(1.3e29), bd(1.35e28), bd(6e30)), true),
    ...
    A_GIANT_PAIR_OF_ROLLER_SKATES: new Enemy(210, "aGiantPairOfRollerSkates", "A Giant Pair Of Roller Skates", ENEMY_TYPE.PARALYZE, new AttackStat(1, bd(3.02e29), bd(4.02e29), bd(4.02e28), bd(2.02e31))),
    ...
    HOLY_CRAP_ITS_ANOTHER_SHARK: new Enemy(214, "holyCrapItsAnotherShark", "Holy Crap It's Another Shark", ENEMY_TYPE.RAPID, new AttackStat(1.2, bd(3.06e29), bd(4.06e29), bd(4.06e28), bd(2.04e31))),
    THE_WORST_VINYL_RECORD: new Enemy(215, "tHEWORSTVINYLRECORD", "THE WORST VINYL RECORD", ENEMY_TYPE.POISON, new AttackStat(1.2, bd(3.08e29), bd(4.08e29), bd(4.08e28), bd(2.05e31)), true),
    ...
    AN_ELEVATOR_FULL_OF_BLOOD: new Enemy(221, "anElevatorFullofBlood", "An Elevator Full of Blood", ENEMY_TYPE.CHARGER, new AttackStat(1.1, bd(1.04e30), bd(1.24e30), bd(1.24e29), bd(6.5e31))),
    ...
    TEXAS_CHAINSAW_MASCARA: new Enemy(223, "tEXASCHAINSAWMASCARABOSS", "TEXAS CHAINSAW MASCARA (BOSS)", ENEMY_TYPE.NORMAL, new AttackStat(1.2, bd(1.08e30), bd(1.28e30), bd(1.28e29), bd(6e31)), true),
    ...
    THREE_GUYS_CARRYING_A_BEAM: new Enemy(229, "GuysCarryingaBeam", "3 Guys Carrying a Beam", ENEMY_TYPE.NORMAL, new AttackStat(1.1, bd(4.04e31), bd(4.24e31), bd(4.24e30), bd(2.08e33))),
    ...
    SEVEN_GUYS_TAKING_A_BREAK: new Enemy(231, "GUYSTAKINGABREAKBOSS", "7 GUYS TAKING A BREAK (BOSS)", ENEMY_TYPE.NORMAL, new AttackStat(1.2, bd(4.08e31), bd(4.28e31), bd(4.28e30), bd(2.1e33)), true),
    ...
    SCIENTIFICALLY_ACCURATE_DUCK: new Enemy(236, "scientificallyAccurateDuck", "Scientifically Accurate Duck", ENEMY_TYPE.PARALYZE, new AttackStat(1, bd(1e32), bd(1e32), bd(1e30), bd(5.03e33))),
    ...
    THE_GRAND_DUTCH_DUCHY: new Enemy(247, "tHEGRANDDUTCHDUCHY", "THE GRAND DUTCH DUCHY", ENEMY_TYPE.NORMAL, new AttackStat(1.2, bd(2.58e32), bd(2.68e32), bd(2.58e30), bd(1.3e34)), true),
    DAAN_VAN_DER_VAN_JAANSEN: new Enemy(248, "dAANVANDERVANJAANSENBOSS", "DAAN VAN DER VAN JAANSEN (BOSS)", ENEMY_TYPE.CHARGER, new AttackStat(1.2, bd(2.6e32), bd(2.6e32), bd(2.55e30), bd(1.3e34)), true),
    ...
    A_BUNCH_OF_OLD_NEWSPAPERS: new Enemy(254, "aBunchofOldNewspapers", "A Bunch of Old Newspapers", ENEMY_TYPE.NORMAL, new AttackStat(1, bd(1.3e34), bd(1.3e34), bd(1.3e32), bd(8.2e35))),
    ...
    A_TAR_BLOB_MONSTER: new Enemy(256, "aTARBLOBMONSTERBOSS", "A TAR BLOB MONSTER (BOSS)", ENEMY_TYPE.POISON, new AttackStat(1, bd(1.3e34), bd(1.3e34), bd(1.3e32), bd(8.34e35)), true),
    ...
    RAMSHACKLE_SEA_INN: new Enemy(264, "rAMSHACKLESEAINNBOSS", "RAMSHACKLE SEA INN (BOSS)", ENEMY_TYPE.CHARGER, new AttackStat(1.1, bd(1.34e34), bd(1.34e34), bd(1.34e32), bd(8.35e35)), true),
