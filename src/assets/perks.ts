...
export const PERKLIST = [
    ...
    new Perk(27, 'daycareKittysBlessingI', 'Daycare Kitty\'s Blessing I', GameMode.NORMAL, 0, [[Stat.DAYCARE_SPEED, 1]]),
    new Perk(28, 'daycareKittysBlessingII', 'Daycare Kitty\'s Blessing II', GameMode.NORMAL, 0, [[Stat.DAYCARE_SPEED, 1]]),
    ...
    new Perk(200, 'fasterCardGenerationI', 'Faster Card Generation I', GameMode.EVIL, 0, [[Stat.CARD_GENERATION, 0.5]]),
    new Perk(201, 'fasterMayoGenerationI', 'Faster Mayo Generation I', GameMode.EVIL, 0, [[Stat.MAYO_GENERATION, 0.5]]),
    new Perk(202, 'fasterCardGenerationII', 'Faster Card Generation II', GameMode.SADISTIC, 0, [[Stat.CARD_GENERATION, 0.4]]),
    new Perk(203, 'fasterMayoGenerationII', 'Faster Mayo Generation II', GameMode.SADISTIC, 0, [[Stat.CARD_GENERATION, 0.4]]),
    new Perk(204, 'fasterCardGenerationIII', 'Faster Card Generation III', GameMode.SADISTIC, 0, [[Stat.CARD_SPEED, 0.3]]),
    new Perk(205, 'fasterMayoGenerationIII', 'Faster Mayo Generation III', GameMode.SADISTIC, 0, [[Stat.MAYO_GENERATION, 0.3]]),
    new Perk(206, 'fasterCardGenerationIV', 'Faster Card Generation IV', GameMode.SADISTIC, 0, [[Stat.CARD_GENERATION, 0.3]]),
    new Perk(207, 'fasterMayoGenerationIV', 'Faster Mayo Generation IV', GameMode.SADISTIC, 0, [[Stat.MAYO_GENERATION, 0.3]]),
    ...
    new Perk(211, 'extraMayoGenerator!', 'Extra Mayo Generator!', GameMode.EVIL, 0, [[Stat.MAYO_GENERATION, 2]]),
    new Perk(212, 'betterTagsI', 'Better Tags I', GameMode.EVIL, 0, [[Stat.TAG_SPEED, 0.05]]),
    new Perk(213, 'betterTagsII', 'Better Tags II', GameMode.SADISTIC, 0, [[Stat.TAG_SPEED, 0.45]]),
    new Perk(214, 'betterTagsIII', 'Better Tags III', GameMode.SADISTIC, 0, [[Stat.TAG_SPEED, 0.04]]),
    new Perk(215, 'betterTagsIV', 'Better Tags IV', GameMode.SADISTIC, 0, [[Stat.TAG_SPEED, 0.04]]),
