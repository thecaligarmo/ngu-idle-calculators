...
export const PERKLIST = [
    ...
    new Perk(2, "heNewbieAdventurePerk", "The Newbie Adventure Perk", GameMode.NORMAL, 0, [
        [Stat.POWER, 10],
        [Stat.TOUGHNESS, 10],
        [Stat.HEALTH, 10],
        [Stat.REGEN, 10],
    ...
    new Perk(4, "theNewbieStatPerk", "The Newbie Stat Perk", GameMode.NORMAL, 0, [
        [Stat.ATTACK, 100],
        [Stat.DEFENSE, 100],
    ]),
    new Perk(5, "statBoostForRichPerksI", "Stat Boost for Rich Perks I", GameMode.NORMAL, 0, [
        [Stat.ATTACK, 10],
        [Stat.DEFENSE, 10],
    ]),
    ...
    new Perk(54, "statBoostforRichPerksII", "Stat Boost for Rich Perks II", GameMode.NORMAL, 0, [
        [Stat.ATTACK, 1],
        [Stat.DEFENSE, 1],
    ]),
    new Perk(55, "adventureBoostForRichPerksI", "Adventure Boost For Rich Perks I", GameMode.NORMAL, 0, [
        [Stat.POWER, 0.1],
        [Stat.TOUGHNESS, 0.1],
        [Stat.HEALTH, 0.1],
        [Stat.REGEN, 0.1],
    ...
    new Perk(82, "statBoostforRichPerksIII", "Stat Boost for Rich Perks III", GameMode.EVIL, 0, [
        [Stat.ATTACK, 1],
        [Stat.DEFENSE, 1],
    ]),
    new Perk(83, "adventureBoostForRichPerksII", "Adventure Boost For Rich Perks II", GameMode.EVIL, 0, [
        [Stat.POWER, 0.1],
        [Stat.TOUGHNESS, 0.1],
        [Stat.HEALTH, 0.1],
        [Stat.REGEN, 0.1],
    ...
    new Perk(125, "welcometoEvilDifficulty", "Welcome to Evil Difficulty", GameMode.EVIL, 0, [
        [Stat.ATTACK, 200],
        [Stat.DEFENSE, 200],
        [Stat.DROP_CHANCE, 50],
    ]),
    ...
    new Perk(144, "welcometoSadisticDifficulty", "Welcome to Sadistic Difficulty", GameMode.SADISTIC, 0, [
        [Stat.ATTACK, 1000],
        [Stat.DEFENSE, 1000],
        [Stat.POWER, 15],
        [Stat.TOUGHNESS, 15],
        [Stat.HEALTH, 15],
        [Stat.REGEN, 15],
        [Stat.ENERGY_NGU_SPEED, 20],
        [Stat.MAGIC_NGU_SPEED, 20],
        [Stat.AUGMENT_SPEED, 20],
    ]), //  <- Doesn't show up in stat breakdown for some reason
    ...
    new Perk(149, "statBoostforrichPerksIV", "Stat Boost for rich Perks IV", GameMode.EVIL, 0, [
        [Stat.ATTACK, 1],
        [Stat.DEFENSE, 1],
    ]),
    new Perk(150, "adventureBoostForRichPerksIII", "Adventure Boost For Rich Perks III", GameMode.EVIL, 0, [
        [Stat.POWER, 0.05],
        [Stat.TOUGHNESS, 0.05],
        [Stat.HEALTH, 0.05],
        [Stat.REGEN, 0.05],
    ]),
    new Perk(151, "statBoostforrichPerksV", "Stat Boost for rich Perks V", GameMode.SADISTIC, 0, [
        [Stat.ATTACK, 1],
        [Stat.DEFENSE, 1],
    ]),
    new Perk(152, "adventureBoostForRichPerksIV", "Adventure Boost For Rich Perks IV", GameMode.SADISTIC, 0, [
        [Stat.POWER, 0.05],
        [Stat.TOUGHNESS, 0.05],
        [Stat.HEALTH, 0.05],
        [Stat.REGEN, 0.05],
    ]),
    new Perk(153, "statBoostforrichPerksVI", "Stat Boost for rich Perks VI", GameMode.SADISTIC, 0, [
        [Stat.ATTACK, 1],
        [Stat.DEFENSE, 1],
    ]),
    new Perk(154, "adventureBoostForRichPerksV", "Adventure Boost For Rich Perks V", GameMode.SADISTIC, 0, [
        [Stat.POWER, 0.05],
        [Stat.TOUGHNESS, 0.05],
        [Stat.HEALTH, 0.05],
        [Stat.REGEN, 0.05],
