...
export const QUIRKLIST = [
    ...
    new Quirk(140, 'fasterCardGenerationII', 'Faster Card Generation II', GameMode.SADISTIC, 1, [[Stat.CARD_SPEED, 0.4]]),
    new Quirk(141, 'fasterMayoGenerationII', 'Faster Mayo Generation II', GameMode.SADISTIC, 1, [[Stat.MAYO_SPEED, 0.4]]),
    new Quirk(142, 'fasterCardGenerationIII', 'Faster Card Generation III', GameMode.SADISTIC, 1, [[Stat.CARD_SPEED, 0.3]]),
    new Quirk(143, 'fasterMayoGenerationIII', 'Faster Mayo Generation III', GameMode.SADISTIC, 1, [[Stat.MAYO_SPEED, 0.3]]),
    new Quirk(144, 'fasterCardGenerationIV', 'Faster Card Generation IV', GameMode.SADISTIC, 1, [[Stat.CARD_SPEED, 0.3]]),
    new Quirk(145, 'fasterMayoGenerationIV', 'Faster Mayo Generation IV', GameMode.SADISTIC, 1, [[Stat.MAYO_SPEED, 0.3]]),
