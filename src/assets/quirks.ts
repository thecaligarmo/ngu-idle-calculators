...
export const QUIRKLIST = [
    ...
    new Quirk(6, 'babysFirstQuirk:Adventure', 'Baby\'s First Quirk: Adventure', GameMode.NORMAL, 1, [[Stat.POWER, 25],[Stat.TOUGHNESS, 25], [Stat.HEALTH, 25], [Stat.REGEN, 25]]),
    new Quirk(7, 'statBoostForRichQuirksI', 'Stat Boost For Rich Quirks I', GameMode.NORMAL, 1, [[Stat.ATTACK, 1], [Stat.DEFENSE, 1]]),
    new Quirk(8, 'adventureBoostForRichQuirksI', 'Adventure Boost For Rich Quirks I', GameMode.NORMAL, 1, [[Stat.POWER, 0.1], [Stat.TOUGHNESS, 0.1], [Stat.HEALTH, 0.1], [Stat.REGEN, 0.1]]),
    ...
    new Quirk(52, 'adventureBoostForRichQuirksII', 'Adventure Boost For Rich Quirks II ', GameMode.EVIL, 1, [[Stat.POWER, 0.1], [Stat.TOUGHNESS, 0.1], [Stat.HEALTH, 0.1], [Stat.REGEN, 0.1]]),
    ...
    new Quirk(77, 'adventureBoostforRichQuirksIII', 'Adventure Boost for Rich Quirks III', GameMode.SADISTIC, 1, [[Stat.POWER, 0.03], [Stat.TOUGHNESS, 0.03], [Stat.HEALTH, 0.03], [Stat.REGEN, 0.03]]),
    new Quirk(78, 'statBoostforRichQuirksIV', 'Stat Boost for Rich Quirks IV', GameMode.SADISTIC, 1, [[Stat.ATTACK, 1], [Stat.DEFENSE, 1]]),
    new Quirk(79, 'adventureBoostforRichQuirksIV', 'Adventure Boost for Rich Quirks IV', GameMode.SADISTIC, 1, [[Stat.POWER, 0.03], [Stat.TOUGHNESS, 0.03], [Stat.HEALTH, 0.03], [Stat.REGEN, 0.03]]),
    ...
    new Quirk(171, 'adventureBoostforRichQuirksV', 'Adventure Boost for Rich Quirks V', GameMode.SADISTIC, 1, [[Stat.POWER, 0.03], [Stat.TOUGHNESS, 0.03], [Stat.HEALTH, 0.03], [Stat.REGEN, 0.03]]),
    new Quirk(172, 'statBoostforRichQuirksVI', 'Stat Boost for Rich Quirks VI', GameMode.SADISTIC, 1, [[Stat.ATTACK, 1], [Stat.DEFENSE, 1]]),
    new Quirk(173, 'adventureBoostforRichQuirksVI', 'Adventure Boost for Rich Quirks VI', GameMode.SADISTIC, 1, [[Stat.POWER, 0.03], [Stat.TOUGHNESS, 0.03], [Stat.HEALTH, 0.03], [Stat.REGEN, 0.03]]),
