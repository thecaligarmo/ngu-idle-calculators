...
export class Beard extends Resource {
    permLevel: number;
    type: string;
    constructor(id: number, key: string, name: string, type: string, props: propType) {
...
export const BEARDLIST = [
    new Beard(0, "fuManchu", "The Fu Manchu", "magic", [
        [Stat.ATTACK, 1],
        [Stat.DEFENSE, 1],
    ]),
    ...
    new Beard(3, "beardCage", "The Beard Cage", "energy", [
        [Stat.ENERGY_NGU_SPEED, 1],
        [Stat.MAGIC_NGU_SPEED, 1],
    ]),
    new Beard(4, "ladybeard", "The LadyBeard", "magic", [
        [Stat.ENERGY_WANDOOS_SPEED, 1],
        [Stat.MAGIC_WANDOOS_SPEED, 1],
    ]),
    new Beard(5, "BEARd", "The BEARd", "energy", [
        [Stat.POWER, 1],
        [Stat.TOUGHNESS, 1],
        [Stat.HEALTH, 1],
        [Stat.REGEN, 1],
