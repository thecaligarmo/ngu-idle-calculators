...
export const WISHLIST = [
    ...
    new Wish(
        6,
        "iwishIwasstrongerinAdventuremodeI",
    ...
    new Wish(
        29,
        "iwishIwasstrongerinAdventuremodeII",
    ...
    new Wish(
        63,
        "iwishtheGreasyNerdcouldatleastwearsomebodyspray",
    ...
    new Wish(
        80,
        "iwishhigherlevelquestdropscountedforevenmoreQuestprogressI",
    ...
    new Wish(
        81,
        "iwishhigherlevelquestdropscountedforevenmoreQuestprogressII",
    ...
    new Wish(
        103,
        "iwishIwasstrongerinAdventureModeIII",
    ...
    new Wish(
        104,
        "iwishIwasstrongerinAdventureModeIV",
    ...
    new Wish(
        105,
        "iwishIcouldbeatupmorebossesIII",
    ...
    new Wish(148, "iwishmyPPCardTierwashigherIII", "I wish my PP Card Tier higher III", GameMode.SADISTIC, 2, [], bd("1e23")),
    ...
    new Wish(152, "iwishmyQPCardTierwashigherIII", "I wish my QP Card Tier higher III", GameMode.SADISTIC, 2, [], bd("1.5e23")),
    ...
    new Wish(
        188,
        "iwishIwasstrongerinAdventureModeV",
        "I wish I was stronger in Adventure Mode V",
        GameMode.SADISTIC,
        20,
        [
            [Stat.POWER, 1],
    ...
    new Wish(
        189,
        "iwishIcouldbeatupmorebossesV",
        "I wish I could beat up more bosses V",
        GameMode.SADISTIC,
        20,
        [
            [Stat.ATTACK, 100],
    ...
    new Wish(
        191,
        "iwishIcouldbeatupmoreBossesVI",
        "I wish I could beat up more Bosses VI",
        GameMode.SADISTIC,
        20,
        [
            [Stat.ATTACK, 100],
    ...
    new Wish(
        192,
        "iwishIcouldbeatupmoreBossesVII",
        "I wish I could beat up more Bosses VII",
        GameMode.SADISTIC,
        20,
        [
            [Stat.ATTACK, 100],
    ...
    new Wish(
        218,
        "iwishIwasstrongerinAdventuremodeVI",
        "I wish I was stronger in Adventure mode VI",
        GameMode.SADISTIC,
        10,
        [
            [Stat.POWER, 1],
    ...
    new Wish(
        219,
        "iwishIcouldbeatupmoreBossesVIII",
        "I wish I could beat up more Bosses VIII",
        GameMode.SADISTIC,
        20,
        [
            [Stat.ATTACK, 100],
    ...
    new Wish(
        226,
        "iwishIwasstrongerinAdventuremodeVI(part2)",
        "I wish I was stronger in Adventure mode VI (part 2)",
        GameMode.SADISTIC,
        10,
        [
            [Stat.POWER, 1],
