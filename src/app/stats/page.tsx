...
import { apItemInfo, beardInfoPerm, beardInfoTemp, challengeInfo, diggerInfo, equipmentInfo, isMaxxedItem, isMaxxedItemSet, nguInfo, perkInfo, quirkInfo, totalEnergyBar, totalEnergyCap, totalEnergyNGUSpeedFactor, totalEnergyPower, totalMagicBar, totalMagicCap, totalMagicNGUSpeedFactor, totalMagicPower, totalRespawnRate } from '@/helpers/calculators';
...
export default function Page() {
    ...
    return (
        <Container title="Stats">
                    ...
                    <div>
                        <ContentSubsection title="Total Energy NGU Speed Factor">
                            <ul>
                                ...
                                <li key="Number">x &apos;A Number&apos; Set ({pn(isMaxxedItemSet(playerStates, "number") ? bd(110) : bd(100), fmt)}%)</li>
            ...
            <ContentSection title="Misc Adventure">
                    <div>
                        <ContentSubsection title="Respawn">
                            <ul>
                                ...
                                <li key="Number">x Clock Set Bonus ({pn(isMaxxedItemSet(playerStates, "clock") ? bd(95) : bd(100), fmt)}%)</li>
