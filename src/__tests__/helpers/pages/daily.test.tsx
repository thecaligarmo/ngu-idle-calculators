...
describe("Daily page - Titan Hourly Info", () => {
    const cases : [[Titan, number], Player, {
        ...
        [[Titans.NONE, 0], earlyNormalPlayer, {
            'ap' : bd(0),
            'exp' : bd(0),
            'ppp' : bd(0),
            'qp' : bd(0),
        }],
        [[Titans.GRAND_TREE, 0], earlyNormalTwoPlayer, {
            'ap' : bd(25),
            'exp' : bd(95),
            'ppp' : bd(0),
            'qp' : bd(0),
        }],
        [[Titans.UUG, 0], midNormalPlayer, {
            'ap' : bd(100.57),
            'exp' : bd(685),
            'ppp' : bd(0),
            'qp' : bd(0),
        }],
        [[Titans.WALDERP, 4], midNormalTwoPlayer, {
            'ap' : bd(262),
            'exp' : bd(2172),
            'ppp' : bd(0),
            'qp' : bd(0),
        }],
        [[Titans.BEAST, 2], lateNormalPlayer, {
            'ap' : bd(354),
            'exp' : bd(78657),
            'ppp' : bd(871450),
            'qp' : bd(0),
        }],
        [[Titans.BEAST, 3], earlyEvilPlayer, {
            'ap' : bd(377),
            'exp' : bd(82194),
            'ppp' : bd(3714700),
            'qp' : bd(0),
        }],
        [[Titans.BEAST, 3], earlyEvilTwoPlayer, {
            'ap' : bd(382),
            'exp' : bd(135653),
            'ppp' : bd(6257075),
            'qp' : bd(0),
        }],
        [[Titans.GODMOTHER, 1], midEvilTwoPlayer, { // Per hour, off by one for version
            'ap' : bd(9360/24), 
            'exp' : bd(77909040/24),
            'ppp' : bd(9152102400/24),
            'qp' : bd(120/24),
        }],
        [[Titans.EXILE, 0], lateEvilPlayer, { // Per hour, off by one for version
            'ap' : bd(9360/24), 
            'exp' : bd(74626956/24),
        ...
        [[Titans.EXILE, 3], earlySadPlayer, { // Per hour, off by one for version
            'ap' : bd(9408/24), 
            'exp' : bd(528321348/24),
