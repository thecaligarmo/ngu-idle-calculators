...
describe("Wandoos Page Helper", () => {
    const cases: [
        Player,
        { minutes: bigDecimal },
        { "98": emNum; meh: emNum; xl: emNum },
        { "98": number; meh: number; xl: number },
        string
    ][] = [
        [
            midNormalTwoPlayer,
    ...
    test.each(cases)("Case %#", (player, extraData, expectedLvls, expectedBonuses, expectedMaxOs) => {
        const infoData = {
