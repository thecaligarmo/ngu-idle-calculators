...
test('Yggdrasil for Early Evil 1', () => {
    ...
    expect(ygg[2].upgradeCost()).toBe(0)
    let ec = expectClose(Number(ygg[2].fruitYield(fruitYieldData).getValue()), 164887, 1)
    ...
    // Pomegranate
    ec = expectClose(Number(ygg[4].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 438577, 1)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[4].upgradeCost()).toBe(0)
    expect(Number(ygg[4].fruitYield(fruitYieldData).getValue())).toBe(0)
    ...
    // Arbitrariness
    ec = expectClose(Number(ygg[7].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 131574, 1)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[7].upgradeCost()).toBe(0)
    ...
    ec = expectClose(Number(ygg[9].fruitYield(fruitYieldData).getValue()), 260370256, 4)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
...
test('Yggdrasil for Early Evil 2', () => {
    ...
    // Gold
    let ec = expectClose(Number(ygg[0].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 108876, 1)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[0].upgradeCost()).toBe(0)
    expect(Number(ygg[0].fruitYield(fruitYieldData).getValue())).toBe(0)

    // PowerA
    ec = expectClose(Number(ygg[1].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 108876, 1)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[1].upgradeCost()).toBe(0)
    expect(Number(ygg[1].fruitYield(fruitYieldData).getValue())).toBe(0)

    // Adventure
    ec = expectClose(Number(ygg[2].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 54438, 1)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[2].upgradeCost()).toBe(0)
    ec = expectClose(Number(ygg[2].fruitYield(fruitYieldData).getValue()), 155773, 1)
    expect(ec[0]).toBeCloseTo(ec[1], 0)

    // Knowledge
    ec = expectClose(Number(ygg[3].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 89823, 1)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[3].upgradeCost()).toBe(0)
    expect(Number(ygg[3].fruitYield(fruitYieldData).getValue())).toBe(12531734)

    // Pomegranate
    ec = expectClose(Number(ygg[4].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 544380, 2)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[4].upgradeCost()).toBe(0)
    expect(Number(ygg[4].fruitYield(fruitYieldData).getValue())).toBe(0)

    // Luck
    ec = expectClose(Number(ygg[5].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 89823, 1)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[5].upgradeCost()).toBe(0)
    expect(Number(ygg[5].fruitYield(fruitYieldData).getValue())).toBeCloseTo(405.7, 1)

    // PowerB
    ec = expectClose(Number(ygg[6].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 54438, 1)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[6].upgradeCost()).toBe(0)
    expect(Number(ygg[6].fruitYield(fruitYieldData).getValue())).toBeCloseTo(155526123.75) 

    // Arbitrariness
    ec = expectClose(Number(ygg[7].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 269468, 2)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[7].upgradeCost()).toBe(0)
    expect(Number(ygg[7].fruitYield(fruitYieldData).getValue())).toBe(8209)

    // Numbers
    ec = expectClose(Number(ygg[8].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 163314, 2)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[8].upgradeCost()).toBe(0)
    expect(Number(ygg[8].fruitYield(fruitYieldData).getValue())).toBeCloseTo(78548.35)

    // Rage
    ec = expectClose(Number(ygg[9].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 449113, 2)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[9].upgradeCost()).toBe(0)
    ec = expectClose(Number(ygg[9].fruitYield(fruitYieldData).getValue()), 438570688, 5)
    expect(ec[0]).toBeCloseTo(ec[1], 0)

    // Macguffin A
    ec = expectClose(Number(ygg[10].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 116258, 2)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[10].upgradeCost()).toBe(2.535e6)
    expect(Number(ygg[10].fruitYield(fruitYieldData).getValue())).toBe(32)

    // PowerD
    ec = expectClose(Number(ygg[11].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 19377, 2)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[11].upgradeCost()).toBe(480000)
    expect(Number(ygg[11].fruitYield(fruitYieldData).getValue())).toBeCloseTo(11.94)

    // Watermelon
    ec = expectClose(Number(ygg[12].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 3516781, 3)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[12].upgradeCost()).toBe(1.805e7)
    expect(Number(ygg[12].fruitYield(fruitYieldData).getValue())).toBe(0)

    // Macguffin B
    ec = expectClose(Number(ygg[13].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 22145, 2)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[13].upgradeCost()).toBe(1.6e6)
    expect(Number(ygg[13].fruitYield(fruitYieldData).getValue())).toBe(1)

    // Quirks
    ec = expectClose(Number(ygg[14].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 37300, 2)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
...
test('Yggdrasil for Mid Evil 1', () => {
    ...
    // Gold
    let ec = expectClose(Number(ygg[0].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 38264, 1)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[0].upgradeCost()).toBe(0)
    // expect(Number(ygg[0].fruitYield(fruitYieldData).getValue())).toBe(0)

    // PowerA
    ec = expectClose(Number(ygg[1].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 76528, 1)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[1].upgradeCost()).toBe(0)
    expect(Number(ygg[1].fruitYield(fruitYieldData).getValue())).toBe(0)

    // Adventure
    ec = expectClose(Number(ygg[2].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 63136, 1)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[2].upgradeCost()).toBe(0)
    ec = expectClose(Number(ygg[2].fruitYield(fruitYieldData).getValue()), 403930, 2)
    expect(ec[0]).toBeCloseTo(ec[1], 0)

    // Knowledge
    ec = expectClose(Number(ygg[3].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 63136, 1)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[3].upgradeCost()).toBe(0)
    expect(Number(ygg[3].fruitYield(fruitYieldData).getValue())).toBe(22127056)

    // Pomegranate
    ec = expectClose(Number(ygg[4].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 631352, 2)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[4].upgradeCost()).toBe(0)
    expect(Number(ygg[4].fruitYield(fruitYieldData).getValue())).toBe(0)

    // Luck
    ec = expectClose(Number(ygg[5].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 63136, 1)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[5].upgradeCost()).toBe(0)
    expect(Number(ygg[5].fruitYield(fruitYieldData).getValue())).toBeCloseTo(491.1, 0)

    // PowerB
    ec = expectClose(Number(ygg[6].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 38264, 1)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[6].upgradeCost()).toBe(0)
    ec = expectClose(Number(ygg[6].fruitYield(fruitYieldData).getValue()), 376659168, 5)
    expect(ec[0]).toBeCloseTo(ec[1], 0)

    // Arbitrariness
    ec = expectClose(Number(ygg[7].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 189406, 2)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[7].upgradeCost()).toBe(0)
    expect(Number(ygg[7].fruitYield(fruitYieldData).getValue())).toBe(8373)

    // Numbers
    ec = expectClose(Number(ygg[8].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 114792, 2)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[8].upgradeCost()).toBe(0)
    ec = expectClose(Number(ygg[8].fruitYield(fruitYieldData).getValue()), 115530.04, 2)
    expect(ec[0]).toBeCloseTo(ec[1], 0)

    // Rage
    ec = expectClose(Number(ygg[9].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 315676, 2)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[9].upgradeCost()).toBe(0)
    ec = expectClose(Number(ygg[9].fruitYield(fruitYieldData).getValue()), 680726272, 5)
    expect(ec[0]).toBeCloseTo(ec[1], 0)

    // Macguffin A
    ec = expectClose(Number(ygg[10].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 378812, 2)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[10].upgradeCost()).toBe(0)
    expect(Number(ygg[10].fruitYield(fruitYieldData).getValue())).toBe(147)

    // PowerD
    ec = expectClose(Number(ygg[11].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 34049, 2)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[11].upgradeCost()).toBe(1.47e6)
    expect(Number(ygg[11].fruitYield(fruitYieldData).getValue())).toBeCloseTo(47.43)

    // Watermelon
    ec = expectClose(Number(ygg[12].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 3788111, 3)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[12].upgradeCost()).toBe(0)
    expect(Number(ygg[12].fruitYield(fruitYieldData).getValue())).toBe(0)

    // Macguffin B
    ec = expectClose(Number(ygg[13].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 51365, 2)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[13].upgradeCost()).toBe(3.6e6)
    expect(Number(ygg[13].fruitYield(fruitYieldData).getValue())).toBe(3)

    // Quirks
    ec = expectClose(Number(ygg[14].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 89888, 2)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
...
test('Yggdrasil for Mid Evil 2', () => {
    ...
    // Gold
    let ec = expectClose(Number(ygg[0].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 72127, 1)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[0].upgradeCost()).toBe(0)
    // expect(Number(ygg[0].fruitYield(fruitYieldData).getValue())).toBe(0)

    // PowerA
    ec = expectClose(Number(ygg[1].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 144254, 1)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[1].upgradeCost()).toBe(0)
    expect(Number(ygg[1].fruitYield(fruitYieldData).getValue())).toBe(0)

    // Adventure
    ec = expectClose(Number(ygg[2].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 119010, 1)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[2].upgradeCost()).toBe(0)
    ec = expectClose(Number(ygg[2].fruitYield(fruitYieldData).getValue()), 772506, 2)
    expect(ec[0]).toBeCloseTo(ec[1], 0)

    // Knowledge
    ec = expectClose(Number(ygg[3].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 119010, 1)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[3].upgradeCost()).toBe(0)
    ec = expectClose(Number(ygg[3].fruitYield(fruitYieldData).getValue()), 1.875e8)
    expect(ec[0]).toBeCloseTo(ec[1], 0)

    // Pomegranate
    ec = expectClose(Number(ygg[4].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 721268, 2)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[4].upgradeCost()).toBe(0)
    expect(Number(ygg[4].fruitYield(fruitYieldData).getValue())).toBe(0)

    // Luck
    ec = expectClose(Number(ygg[5].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 119010, 1)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[5].upgradeCost()).toBe(0)
    expect(Number(ygg[5].fruitYield(fruitYieldData).getValue())).toBeCloseTo(763.35, 0)

    // PowerB
    ec = expectClose(Number(ygg[6].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 72127, 1)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[6].upgradeCost()).toBe(0)
    ec = expectClose(Number(ygg[6].fruitYield(fruitYieldData).getValue()), 1040427172.05)
    expect(ec[0]).toBeCloseTo(ec[1], 0)

    // Arbitrariness
    ec = expectClose(Number(ygg[7].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 357028, 2)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[7].upgradeCost()).toBe(0)
    expect(Number(ygg[7].fruitYield(fruitYieldData).getValue())).toBe(8394)

    // Numbers
    ec = expectClose(Number(ygg[8].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 216381, 2)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[8].upgradeCost()).toBe(0)
    ec = expectClose(Number(ygg[8].fruitYield(fruitYieldData).getValue()), 212119.47, 2)
    expect(ec[0]).toBeCloseTo(ec[1], 0)

    // Rage
    ec = expectClose(Number(ygg[9].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 595046, 2)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[9].upgradeCost()).toBe(0)
    ec = expectClose(Number(ygg[9].fruitYield(fruitYieldData).getValue()), 8122348544)
    expect(ec[0]).toBeCloseTo(ec[1], 0)

    // Macguffin A
    ec = expectClose(Number(ygg[10].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 714055, 2)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[10].upgradeCost()).toBe(0)
    expect(Number(ygg[10].fruitYield(fruitYieldData).getValue())).toBe(174)

    // PowerD
    ec = expectClose(Number(ygg[11].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 444986, 2)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[11].upgradeCost()).toBe(1.587e7)
    ec = expectClose(Number(ygg[11].fruitYield(fruitYieldData).getValue()), 812.25)
    expect(ec[0]).toBeCloseTo(ec[1], 0)

    // Watermelon
    ec = expectClose(Number(ygg[12].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 4327605, 3)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[12].upgradeCost()).toBe(0)
    expect(Number(ygg[12].fruitYield(fruitYieldData).getValue())).toBe(0)

    // Macguffin B
    ec = expectClose(Number(ygg[13].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 952074, 2)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[13].upgradeCost()).toBe(0)
    expect(Number(ygg[13].fruitYield(fruitYieldData).getValue())).toBe(35)

    // Quirks
    ec = expectClose(Number(ygg[14].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 169437, 2)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[14].upgradeCost()).toBe(0)
...
test('Yggdrasil for Late Evil 1', () => {
    ...
    // Gold
    let ec = expectClose(Number(ygg[0].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 98350, 1)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[0].upgradeCost()).toBe(0)
    // expect(Number(ygg[0].fruitYield(fruitYieldData).getValue())).toBe(0)

    // PowerA
    ec = expectClose(Number(ygg[1].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 98350, 1)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[1].upgradeCost()).toBe(0)
    ec = expectClose(Number(ygg[1].fruitYield(fruitYieldData).getValue()), 1.681e8 / 100)
    expect(ec[0]).toBeCloseTo(ec[1], 0)

    // Adventure
    ec = expectClose(Number(ygg[2].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 162277, 1)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[2].upgradeCost()).toBe(0)
    ec = expectClose(Number(ygg[2].fruitYield(fruitYieldData).getValue()), 928534, 2)
    expect(ec[0]).toBeCloseTo(ec[1], 0)

    // Knowledge
    ec = expectClose(Number(ygg[3].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 162277, 1)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[3].upgradeCost()).toBe(0)
    ec = expectClose(Number(ygg[3].fruitYield(fruitYieldData).getValue()), 1.201e8)
    expect(ec[0]).toBeCloseTo(ec[1], 0)

    // Pomegranate
    ec = expectClose(Number(ygg[4].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 983494, 2)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[4].upgradeCost()).toBe(0)
    expect(Number(ygg[4].fruitYield(fruitYieldData).getValue())).toBe(0)

    // Luck
    ec = expectClose(Number(ygg[5].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 162277, 1)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[5].upgradeCost()).toBe(0)
    expect(Number(ygg[5].fruitYield(fruitYieldData).getValue())).toBeCloseTo(816.5, 0)

    // PowerB
    ec = expectClose(Number(ygg[6].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 98350, 1)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[6].upgradeCost()).toBe(0)
    ec = expectClose(Number(ygg[6].fruitYield(fruitYieldData).getValue()), 1500842010.8)
    expect(ec[0]).toBeCloseTo(ec[1], 0)

    // Arbitrariness
    ec = expectClose(Number(ygg[7].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 486830, 2)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[7].upgradeCost()).toBe(0)
    expect(Number(ygg[7].fruitYield(fruitYieldData).getValue())).toBe(8394)

    // Numbers
    ec = expectClose(Number(ygg[8].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 295049, 2)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[8].upgradeCost()).toBe(0)
    ec = expectClose(Number(ygg[8].fruitYield(fruitYieldData).getValue()), 247681.26, 2)
    expect(ec[0]).toBeCloseTo(ec[1], 0)

    // Rage
    ec = expectClose(Number(ygg[9].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 811383, 2)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[9].upgradeCost()).toBe(0)
    ec = expectClose(Number(ygg[9].fruitYield(fruitYieldData).getValue()), 18820003840)
    expect(ec[0]).toBeCloseTo(ec[1], 0)

    // Macguffin A
    ec = expectClose(Number(ygg[10].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 973659, 2)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[10].upgradeCost()).toBe(0)
    expect(Number(ygg[10].fruitYield(fruitYieldData).getValue())).toBe(168)

    // PowerD
    ec = expectClose(Number(ygg[11].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 688446, 2)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[11].upgradeCost()).toBe(0)
    ec = expectClose(Number(ygg[11].fruitYield(fruitYieldData).getValue()), 1213.81)
    expect(ec[0]).toBeCloseTo(ec[1], 0)

    // Watermelon
    ec = expectClose(Number(ygg[12].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 9736590, 3)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[12].upgradeCost()).toBe(0)
    expect(Number(ygg[12].fruitYield(fruitYieldData).getValue())).toBe(0)

    // Macguffin B
    ec = expectClose(Number(ygg[13].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 1.298e6)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[13].upgradeCost()).toBe(0)
    expect(Number(ygg[13].fruitYield(fruitYieldData).getValue())).toBe(34)

    // Quirks
    ec = expectClose(Number(ygg[14].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 231038, 2)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[14].upgradeCost()).toBe(0)
...
test('Yggdrasil for Early Sad 1', () => {
    ...
    // Gold
    let ec = expectClose(Number(ygg[0].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 74395, 1)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[0].upgradeCost()).toBe(0)
    // expect(Number(ygg[0].fruitYield(fruitYieldData).getValue())).toBe(0)

    // PowerA
    ec = expectClose(Number(ygg[1].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 74395, 1)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[1].upgradeCost()).toBe(0)
    ec = expectClose(Number(ygg[1].fruitYield(fruitYieldData).getValue()), 2.926e8 / 100)
    expect(ec[0]).toBeCloseTo(ec[1], 0)

    // Adventure
    ec = expectClose(Number(ygg[2].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 122752, 1)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[2].upgradeCost()).toBe(0)
    ec = expectClose(Number(ygg[2].fruitYield(fruitYieldData).getValue()), 2.163e6)
    expect(ec[0]).toBeCloseTo(ec[1], 0)

    // Knowledge
    ec = expectClose(Number(ygg[3].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 122752, 1)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[3].upgradeCost()).toBe(0)
    ec = expectClose(Number(ygg[3].fruitYield(fruitYieldData).getValue()), 1.059e9)
    expect(ec[0]).toBeCloseTo(ec[1], 0)

    // Pomegranate
    ec = expectClose(Number(ygg[4].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 743948, 2)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[4].upgradeCost()).toBe(0)
    expect(Number(ygg[4].fruitYield(fruitYieldData).getValue())).toBe(0)

    // Luck
    ec = expectClose(Number(ygg[5].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 122752, 1)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[5].upgradeCost()).toBe(0)
    expect(Number(ygg[5].fruitYield(fruitYieldData).getValue())).toBeCloseTo(1181.49, 0)

    // PowerB
    ec = expectClose(Number(ygg[6].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 74395, 1)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[6].upgradeCost()).toBe(0)
    ec = expectClose(Number(ygg[6].fruitYield(fruitYieldData).getValue()), 4111683079.15)
    expect(ec[0]).toBeCloseTo(ec[1], 0)

    // Arbitrariness
    ec = expectClose(Number(ygg[7].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 368255, 2)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[7].upgradeCost()).toBe(0)
    expect(Number(ygg[7].fruitYield(fruitYieldData).getValue())).toBe(8426)

    // Numbers
    ec = expectClose(Number(ygg[8].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 223185, 2)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[8].upgradeCost()).toBe(0)
    ec = expectClose(Number(ygg[8].fruitYield(fruitYieldData).getValue()), 432853.35, 2)
    expect(ec[0]).toBeCloseTo(ec[1], 0)

    // Rage
    ec = expectClose(Number(ygg[9].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 613757, 2)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[9].upgradeCost()).toBe(0)
    ec = expectClose(Number(ygg[9].fruitYield(fruitYieldData).getValue()), 52860538880)
    expect(ec[0]).toBeCloseTo(ec[1], 0)

    // Macguffin A
    ec = expectClose(Number(ygg[10].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 736509, 2)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[10].upgradeCost()).toBe(0)
    expect(Number(ygg[10].fruitYield(fruitYieldData).getValue())).toBe(161)

    // PowerD
    ec = expectClose(Number(ygg[11].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 520764, 2)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[11].upgradeCost()).toBe(0)
    ec = expectClose(Number(ygg[11].fruitYield(fruitYieldData).getValue()), 2375.62)
    expect(ec[0]).toBeCloseTo(ec[1], 0)

    // Watermelon
    ec = expectClose(Number(ygg[12].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 7365084, 3)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[12].upgradeCost()).toBe(0)
    expect(Number(ygg[12].fruitYield(fruitYieldData).getValue())).toBe(0)

    // Macguffin B
    ec = expectClose(Number(ygg[13].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 982012)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[13].upgradeCost()).toBe(0)
    expect(Number(ygg[13].fruitYield(fruitYieldData).getValue())).toBe(33)

    // Quirks
    ec = expectClose(Number(ygg[14].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 174765, 2)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[14].upgradeCost()).toBe(0)
    expect(Number(ygg[14].fruitYield(fruitYieldData).getValue())).toBe(2236)

    // Angry Mayo
    ec = expectClose(Number(ygg[15].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 119789, 2)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[15].upgradeCost()).toBe(6.4e7)
    expect(Number(ygg[15].fruitYield(fruitYieldData).getValue())).toBeCloseTo(0.57)

    // Sad Mayo
    ec = expectClose(Number(ygg[16].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 119789, 2)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[16].upgradeCost()).toBe(6.4e7)
    expect(Number(ygg[16].fruitYield(fruitYieldData).getValue())).toBeCloseTo(0.57, 2)

    // Moldy Mayo
    ec = expectClose(Number(ygg[17].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 119789, 2)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[17].upgradeCost()).toBe(6.4e7)
    expect(Number(ygg[17].fruitYield(fruitYieldData).getValue())).toBeCloseTo(0.57, 2)

    // Ayy Mayo
    ec = expectClose(Number(ygg[18].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 132398, 2)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[18].upgradeCost()).toBe(7.225e7)
    expect(Number(ygg[18].fruitYield(fruitYieldData).getValue())).toBeCloseTo(0.61, 2)

    // Cinco Mayo
    ec = expectClose(Number(ygg[19].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 132398, 2)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
    expect(ygg[19].upgradeCost()).toBe(7.225e7)
    expect(Number(ygg[19].fruitYield(fruitYieldData).getValue())).toBeCloseTo(0.61, 2)

    // Pretty Mayo
    ec = expectClose(Number(ygg[20].seedYield(seedModifier, firstHarvest, blueHeart).getValue()), 132398, 2)
    expect(ec[0]).toBeCloseTo(ec[1], 0)
